...
class NNet
  ...
  def create_hidden_layer
    Array.new(num_hidden_nodes, init_weight)
  end

  def create_output_layer
    Array.new(num_outputs, init_weight)
  end
  ...
  def create_hidden_weights
    Array.new(num_inputs).map { |hw| Array.new(num_hidden_nodes, init_weight) }
  end

  def create_output_weights
    Array.new(num_hidden_nodes).map { |ow| Array.new(num_outputs, init_weight) }
  end
